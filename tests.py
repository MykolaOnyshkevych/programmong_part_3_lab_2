...
class TestCalendar(unittest.TestCase):
    ...
    def test_normal_meetings(self):
        self.merged_normal_meetings = merge_ranges(self.normal_meetings)
        self.assertEqual(self.merged_normal_meetings, self.result_normal_list)

    def test_meetings_without_break(self):
        self.merged_meetings_without_break = merge_ranges(self.meetings_without_break)
        self.assertEqual(self.merged_meetings_without_break, self.result_list_without_break)

    def test_meetings_with_repeat(self):
        self.merged_meetings_with_repeat = merge_ranges(self.meetings_with_repeat)
        self.assertEqual(self.merged_meetings_with_repeat, self.result_with_repeat)
